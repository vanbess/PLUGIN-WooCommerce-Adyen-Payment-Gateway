 ...
 */
class SBAdyenSofort extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        /* method id */
        $this->id = 'sb-adyen-sofort';

        /* method title */
        $this->method_title = esc_attr__('SB Adyen SOFORT (AKA KLARNA PAY NOW)', 'sb-adyen-sofort');

        /* method description */
        $this->method_description = esc_attr__('Adyen Sofort (Klarna Pay Now) payments.', 'sb-adyen-sofort');

        /* gateway icon */
        $this->icon = plugin_dir_url(__FILE__) . 'images/sofort-payment-icon.svg';
    ...
    public function settings_fields()
    {
        ...
        $this->form_fields = [
            /* enable/disable */
            'enabled' => [
                'title'   => esc_attr__('Enable / Disable', 'sb-adyen-sofort'),
                'label'   => esc_attr__('Enable this payment gateway', 'sb-adyen-sofort'),
                'type'    => 'checkbox',
                'default' => 'no',
            ],
            'title'   => [
                'title'       => __('Title', 'sb-adyen-sofort'),
                'type'        => 'text',
                'description' => __('Add your custom payment method title here if required.', 'sb-adyen-sofort'),
                'default'     => __('Sofort/Klarna', 'sb-adyen-sofort'),
            ]
        ];
    }
    ...
    public function process_payment($order_id)
    {
        ...
        $order->update_status('pending', __('Awaiting SOFORT payment', 'sb-adyen-sofort'));
        ...
        try {
            ...
            file_put_contents(SB_ADYEN_PATH . 'error-logs/sofort/error.log', $_SERVER['REQUEST_TIME'] . ': ' . $ex->getMessage() . PHP_EOL, FILE_APPEND);
        }
