 ...
 */
class SBAdyenAliPayHK extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        /* method id */
        $this->id = 'sb-adyen-alipay-hk';

        /* method title */
        $this->method_title = esc_attr__( 'SB Adyen AliPay HK', 'woocommerce' );

        /* method description */
        $this->method_description = esc_attr__( 'Adyen AliPay HK payments.', 'woocommerce' );

        /* gateway icon */
        $this->icon = plugin_dir_url( __FILE__ ) . 'images/AlipayHK.png';
    ...
    public function settings_fields() {
        ...
        $this->form_fields = [
                ...
                'enabled' => [
                        ...
                        'label'   => esc_attr__( 'Enable this payment gateway', 'woocommerce' ),
                        'type'    => 'checkbox',
                        'default' => 'no',
                ],
                'title'   => [
                        ...
                        'type'        => 'text',
                        'description' => __( 'Add your custom payment method title here if required.', 'woocommerce' ),
                        'default'     => __( 'AliPay HK', 'woocommerce' ),
                ]
        ];
    }
    ...
    public function process_payment($order_id) {
        ...
        $order->update_status( 'pending', __( 'Awaiting AliPay HK payment', 'woocommerce' ) );
