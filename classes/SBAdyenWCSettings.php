...
class SBAdyenWCSettings
{
    ...
    public static function get_sb_adyen_settings()
    {
        $settings = [
            ...
            // 3D SECURE SETTINGS
            [
                'title'   => esc_attr__('Enable 3D Secure for Credit Card transactions when shipping and billing address is different?', 'sb-adyen'),
                'type'    => 'select',
                'options' => [
                    'yes' => 'YES',
                    'no' => 'NO'
                ],
                'desc'    => 'If YES, 3D Secure will be used if billing and shipping addresses do not match', 'sb-adyen',
                'id'      => 'sb_adyen_3d_billing'
            ],
            [
                'title'   => esc_attr__('Enable 3D Secure for Credit Card transactions if transaction amount is above a certain amount?', 'sb-adyen'),
                'type'    => 'text',
                'placeholder' => 'enter amount here, e.g. 250',
                'desc'    => 'If transaction amount present, any Credit Card transaction equal to or above this amount will use 3D Secure', 'sb-adyen',
                'id'      => 'sb_adyen_3d_amount'
            ],
            [
                'title'   => esc_attr__('Enable 3D Secure for Credit Card transactions for specific country code?', 'sb-adyen'),
                'type'    => 'text',
                'placeholder' => 'enter country code here, e.g. DE',
                'desc'    => 'If country code(s) present, any Credit Card transaction originating from a country defined here will use 3D Secure<br>'
                    . '<b><u>NOTE:</u></b> If you want to add more than one country, separate each country code with a comma, e.g. DE,FR,ZA', 'sb-adyen',
                'id'      => 'sb_adyen_3d_countries'
            ],
